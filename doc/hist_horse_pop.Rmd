...
knitr::kable(max_horses ,caption = "Table 1. This is the horse population in Canada") |> 
...
```{r plot province, fig.align='center', fig.cap="figure 2. horses per province", fig.height=4, fig.width=5, message=FALSE, warning=FALSE}
